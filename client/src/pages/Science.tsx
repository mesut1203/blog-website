...
export default function Science() {
    ...
    const [activeFilterId, setActiveFilterId] = usePersistedState('sci_filter', 'All');
    const [searchQuery, setSearchQuery] = usePersistedState('sci_search', '');
    const [debouncedSearch, setDebouncedSearch] = useState(searchQuery);
    const [isFilterOpen, setIsFilterOpen] = useState(false);
    const [currentPage, setCurrentPage] = usePersistedState('sci_page', 1);
    const limit = 6;
