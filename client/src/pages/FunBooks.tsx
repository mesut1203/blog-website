...
export default function FunBooks() {
    ...
    const [activeFilterId, setActiveFilterId] = usePersistedState('fb_filter', 'All');
    const [searchQuery, setSearchQuery] = usePersistedState('fb_search', '');
    const [debouncedSearch, setDebouncedSearch] = useState(searchQuery);
    const [isFilterOpen, setIsFilterOpen] = useState(false);
    const [currentPage, setCurrentPage] = usePersistedState('fb_page', 1);
    const limit = 6;
